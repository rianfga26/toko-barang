...
@section('konten')
            <p class="lead font-weight-normal">Management Product / Catalog</p>

            <div class="section-body">
            <h2 class="section-title">Catalog</h2>
            <p class="section-lead">
              Kamu bisa mengelola porduct dari menambah,menghapus,mengedit barang
            </p>
                ...
                <div class="card mb-0">
                  <div class="card-body">
                    <ul class="nav nav-pills">
                      ...
                      <li class="nav-item">
                        <a class="nav-link " href="#" >Tambah Baru</a>
                      </li>
                    </ul>
                  </div>
                </div>
